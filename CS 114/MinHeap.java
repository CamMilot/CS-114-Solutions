...
public class MinHeap<E extends Comparable<E>> {
	...
	public int n; // Number of things in heap
	...
	public MinHeap(ArrayList<MovieRating> rl) {
		Heap = rl;
		n = rl.size();
		buildheap();
	}
	...
	/** Return (not remove) Minimum value */
	public MovieRating peek() {
		if (n != 0)
			return Heap.get(0);
		else
			return null;
